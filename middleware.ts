...
export async function middleware(request: NextRequest) {
  ...
  const publicRoutes = ['/login', '/api/auth/login', '/workflow', '/api/workflow', '/portal', '/api/portal', '/portals', '/api/portals', '/api/webhooks', '/api/showcase', '/api/cron', '/api/schedule/export', '/api/slack', '/api/internal', '/api/elevenlabs', '/api/kb', '/presentation', '/wrike-airtable-scope', '/proof', '/api/proof-share', '/samples', '/api/public', '/dashboard/ops-overview', '/dashboard/design-content', '/_next', '/favicon', '/ANC_Logo_2023_blue.png', '/ANC_Logo_2023_white.png']
