...
export async function middleware(request: NextRequest) {
  ...
  const publicRoutes = ['/customer', '/api/customer', '/login', '/api/auth/login', '/api/auth/microsoft', '/api/auth/callback/microsoft-entra-id', '/workflow', '/api/workflow', '/portal', '/api/portal', '/portals', '/api/portals', '/client-portals/p', '/dealdeck', '/marketing-hub/concepts', '/brand-2026', '/api/forms', '/api/webhooks', '/api/showcase', '/api/cron', '/api/schedule/export', '/api/slack', '/api/internal', '/api/elevenlabs', '/api/kb', '/api/walkthroughs/nocodb/hook', '/api/twenty-bridge', '/presentation', '/wrike-airtable-scope', '/anc-live-command', '/proof', '/api/proof-share', '/samples', '/api/public', '/transparency', '/dashboard/ops-overview', '/dashboard/design-content', '/d', '/api/dashboards', '/api/gamification', '/_next', '/favicon', '/ANC_Logo_2023_blue.png', '/ANC_Logo_2023_white.png', '/api/marketing/track', '/api/marketing/unsubscribe']
