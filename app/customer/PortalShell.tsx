  ...
  const nav = (onNavigate?: () => void) => (
    <>
      ...
      <div className="cp-side-foot">
        {sidebarOpen && user && (
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-2">
              <Link href="/customer/account" onClick={onNavigate} className="cp-side-signout">
                Account settings
              </Link>
              <span className="cp-side-signout" aria-hidden="true">·</span>
        ...
        {!sidebarOpen && (
          <>
            <Link href="/customer/account" onClick={onNavigate} className="cp-side-link" title="Account settings">
