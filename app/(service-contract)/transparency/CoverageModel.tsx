...
export default function CoverageModel() {
  return (
    <section id="model" className="scroll-mt-32 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 shadow-sm mb-4">
      <div className="mb-4">
        <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Three buckets — what falls where</h2>
      ...
      <div className="mt-5 pt-5 border-t border-zinc-100 dark:border-zinc-800">
        <div className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 dark:text-zinc-400 mb-3">
          ...
          {PLATFORMS.map((p) => (
            <div key={p.name} className="flex gap-2.5 py-1.5">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-snug">{p.detail}</div>
              </div>
            </div>
          ))}
        </div>
