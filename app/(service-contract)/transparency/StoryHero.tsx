...
export default function StoryHero({ story }: Props) {
  ...
  const pacingGradient =
    story.pacing_status === 'over' ? 'from-rose-500 to-rose-600'
    : story.pacing_status === 'behind' ? 'from-amber-500 to-amber-600'
    : story.pacing_status === 'ahead' ? 'from-blue-500 to-blue-600'
