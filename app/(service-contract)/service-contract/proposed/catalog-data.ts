...
export const SERVICE_TIERS: ServiceTier[] = [
  ...
  },
  {
    ...
    recommended: true,
    tagline: 'The wow tier · everything absorbed',
    best_for: 'Teams that want one number, zero surprise invoices',
    perks: [
      ...
      'Half-off Charlie Full Operator if you renew ($10K vs $18K)',
...
export const OPERATOR_PROGRAM: OperatorOption[] = [
  ...
  },
  {
    ...
    price: 18000,
    tagline: 'Turn Charlie into Ahmad · transfer the whole stack',
    description: 'Operator preparation + full personal AI toolkit transfer. After this Charlie can ship fixes and features in-house at engineering speed.',
    includes: [
      'Everything in Basic',
      'Personal AI toolkit transferred + configured on Charlie\'s workstation',
      'Agent skills, prompt libraries, model routing, multi-agent orchestration',
      'Dev + deploy workflow — ship a fix or feature in hours, not days',
      ...
      'Operator handbook + personal AI operator playbook',
    ],
  },
]
...
export const BUNDLES: Bundle[] = [
  ...
  },
  {
    ...
    saves: 18000,
    badge: 'Best Deal',
    tagline: 'Everything absorbed · Charlie Full included free',
    highlights: [
      '50h maintenance + 12h build / month',
      'Same-day SLA',
      'Charlie Full Operator INCLUDED — $18K of value bundled in',
      'Quarterly Charlie training sessions',
      'Half-off Full Operator on renewal',
    ],
  },
]
