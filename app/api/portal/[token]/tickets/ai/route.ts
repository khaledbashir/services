...
{"title":"...","category":"...","priority":"...","description":"...","follow_up":["...","...","..."],"sentiment":"...","urgency_note":"..."}`
    ...
    const result = await query(
      `INSERT INTO tickets (venue_id, title, description, category, priority, status, created_by, assigned_to, sla_response_due, sla_resolution_due, original_message, source)
       VALUES ($1, $2, $3, $4, $5, 'new', $6, $7, $8, $9, $10, 'portal')
       RETURNING id, ticket_number, title, category, priority, status`,
