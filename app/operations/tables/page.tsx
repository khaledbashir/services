  ...
  return (
    <DashboardLayout>
      <div className="space-y-5">
        <div>
          <Link href="/operations" className="mb-3 inline-flex text-xs font-medium text-zinc-500 hover:text-zinc-900">
            Back to Ops Workspace
          </Link>
          <h1 className="text-2xl font-semibold text-zinc-900">Raw Operations Tables</h1>
          <p className="mt-1 text-sm text-zinc-500">
            Administrative fallback for every operations base and table.
          </p>
        </div>
