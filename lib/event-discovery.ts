...
// Match genuine TBD placeholder schedule entries only. "(If Necessary)" is
// stripped upstream in stripPlayoffSuffix because the underlying game is real
// even when Ticketmaster keeps the marker after the prior series game has
// settled it.
